...
public enum ResponseCode {
    ...
    LOTTO_STATS_OK(HttpStatus.OK,"로또 정보를 성공적으로 가져왔습니다."),
    LOTTO_STATS_FAIL(HttpStatus.BAD_REQUEST,"로또 정보를 가져오는데 실패했습니다."),
    LOTTO_RANDOM_OK(HttpStatus.OK,"로또 번호 랜덤 추출을 성공했습니다.")
    ;
